//_________________________________________________ xd_cxxopts.h ____________________________________________________________
#pragma once
...
//_____________________________________________________________________________________________________________________________
    ...
    namespace detail
    {
        ...
        static Xd_ValueStrMap &parse_args_helper(OptionParser &parser,
    ...
    public:
        ...
        Xd_ValueStrMap &parse_args(int argc, char const *const *argv)
        {
            if (prog() == "")
            {
        ...
        Xd_ValueStrMap &parse_args(const std::vector<std::string> &arguments)
        {
            return detail::parse_args_helper(*this, arguments);
        }

        template<typename InputIterator>
        Xd_ValueStrMap &parse_args(InputIterator begin, InputIterator end)
        {
    ...
    private:
        ...
        friend Xd_ValueStrMap &detail::parse_args_helper(
            OptionParser &parser,
            const std::vector<std::string> &v);
